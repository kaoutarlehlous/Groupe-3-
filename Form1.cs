...
namespace Sudoku
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
        ...
        /// 
            ...
            // Calculer Dispose o utiliser Components
		...
		private void InitializeComponent()
		{
            ...
            this.statusBar1.Size = new System.Drawing.Size(352, 26);
		...
		private void Form1_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			...
			for (int i = 0; i < 9; i++)
				for (int j = 0; j < 9; j++)
				{
					if (_gene != null)
					{
						int val = (_gene as Sudokufitness)[i, j];
